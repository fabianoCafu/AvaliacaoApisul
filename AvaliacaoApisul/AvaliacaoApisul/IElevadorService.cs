...
namespace AvaliacaoApisul
{
    interface IElevadorService
    {
        ...
        List<char> PeriodoDeMaiorTransitoElevadorMaisFrequentado();
        ...
        List<char> PeriodoDeMenorTransitoElevadorMenosFrequentado();

        /// <summary> Deve retornar uma List contendo o(s) periodo(s) de maior utilização do conjunto de elevadores. </summary> 
        List<char> PeriodoDeMaiorTransitoNoConjuntoDeElevadores();
